...
var dataDQF = [
    ...
    [2014, 5.4, 19874.9, "单身男女2 單身男女II", "喜剧 / 爱情"],
    [2015, 6, 4750, "华丽上班族 華麗上班族", "剧情 / 喜剧 / 爱情 / 歌舞"],
    [2016, 5.9, 10054, "三人行", "剧情 / 动作 / 犯罪"],
    [2003, 6.4, 1401, "大块头有大智慧 大隻佬", "剧情 / 动作 / 惊悚"],
];
var dataEDS = [
    [2005, 6.3, 579.4, "千杯不醉", "喜剧 / 爱情"],
    [2010, 6.6, 12658, "枪王之王", "动作 / 悬疑 / 惊悚"],
    [2012, 6.6, 17364.1, "大魔术师 大魔術師", "剧情 / 喜剧 / 爱情 / 奇幻"],
    [2015, 7.2, 6319.3, "我是路人甲", "剧情 / 喜剧"],
];
var dataLCX = [
    [2008, 7.2, 1547.6, "证人", "动作 / 惊悚"],
    [2010, 7.3, 5276.3, "线人 線人", "剧情 / 动作 / 惊悚"],
    [2010, 6.1, 1843, "火龙对决", "动作 / 惊悚"],
    [2012, 6.4, 12940.3, "逆战", "剧情 / 动作 / 惊悚 / 犯罪"],
    [2013, 7.8, 11789, "激战 激戰", "剧情 / 动作 / 运动"],
    [2014, 5.9, 10833, "魔警", "动作 / 悬疑 / 惊悚 / 犯罪"],
    [2015, 7.2, 14529.1, "破风 破風", "剧情 / 运动"],
...
var dataPHX = [
    [2012, 7.3, 7059, "春娇与志明 春嬌與志明", "剧情 / 喜剧 / 爱情"],
    [2014, 5.8, 23048, "撒娇女人最好命", "喜剧 / 爱情"],
    [2014, 5.3, 1430, "人间·小团圆 香港仔", "剧情"],
    [2017, 7.2, 17483, "春娇救志明 春嬌救志明", "剧情 / 喜剧 / 爱情"],
];
var dataWJW = [
    [2004, 7.4, 2.3, "2046", "剧情 / 爱情 / 科幻 / 奇幻"],
    [2007, 7.6, 1207, "蓝莓之夜 My Blueberry Nights", "剧情 / 爱情"],
    [2009, 8.7, 2580, "东邪西毒：终极版 東邪西毒終極版", "剧情 / 动作 / 爱情"],
    [2013, 7.7, 28923, "一代宗师 一代宗師", "剧情 / 动作 / 传记"],
];
var dataWJ = [
    [2009, 5, 10022.3, "大内密探灵灵狗 大內密探靈靈狗", "喜剧"],
    ...
    [2016, 3.9, 111818, "澳门风云3 賭城風雲III", "喜剧 / 动作"],
    [2015, 5.6, 97491, "澳门风云2 賭城風雲II", "喜剧 / 动作"],
    [2014, 5.7, 52489, "澳门风云 賭城風雲", "喜剧 / 动作"],
];
var dataWYS = [
...
var dataYWX = [
    ...
    [2007, 6.9, 3461.9, "导火线 導火線", "动作"],
    [2008, 7.5, 8487.0, "叶问 葉問", "剧情 / 动作 / 传记 / 历史"],
    ...
    [2017, 7.5, 8424.4, "杀破狼·贪狼 殺破狼‧貪狼", "剧情 / 动作"],
    [2015, 4.4, 15631.4, "冲上云霄 衝上雲霄", "剧情 / 爱情"],
];
var dataZXC = [
...
option = {
    ...
    color: [
        '#dd4444', '#fec42c', '#80F1BE', '#00755E', '#495A80', "#FFB5C5", '#9A32CD', '#96CDCD', '#00F5FF', '#8B5A00', '#9400D3', '#9BCD9B', '#CD6090', '#C1FFC1', '#8B4513'
    ],
    legend: {
        y: 'top',
